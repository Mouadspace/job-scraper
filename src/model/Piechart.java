...
public class Piechart extends JFrame {
    ...
    private List<String> getSectorList() {
        ...
        try {
            // Include "LIMIT 100" in the query to limit the results to 100 rows
    ...
    private List<String> getCityList() {
        ...
        try {
            String query = "SELECT DISTINCT city FROM Offre WHERE SiteName='rekrute.com' LIMIT 20";
            try (PreparedStatement statement = con.prepareStatement(query)) {
                try (ResultSet resultSet = statement.executeQuery()) {
                    while (resultSet.next()) {
